...
<div id="homePageBanner"  class="heroBanner blogBanner commanBanner" style="background-image:url('<?php echo site_url(); ?>/wp-content/uploads/2022/03/domedome.jpg');background-repeat:no-repeat;background-size:cover">	
</div>

<div id="snglBlogCont" class="snglBlogCont section allBlog">
