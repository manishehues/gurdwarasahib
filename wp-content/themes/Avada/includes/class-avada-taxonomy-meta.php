	...
	public static function avada_taxonomy_map() {
		...
		if ( ! $ptb_override ) {
			...
			$sections['taxonomy_options']['fields']['page_title_height'] = [
				...
				/* translators: Additional description (defaults). */
				'description' => sprintf( esc_html__( 'Controls the height of the page title bar on desktop. Enter value including any valid CSS unit besides %% which does not work for page title bar, ex: 87px. %s', 'Avada' ), Avada()->settings->get_default_description( 'page_title_height' ) ),
				'type'        => 'text',
				'location'    => 'TAXO',
				'css_vars'    => [
					[
			...
			$sections['taxonomy_options']['fields']['page_title_mobile_height'] = [
				...
				/* translators: Additional description (defaults). */
				'description' => sprintf( esc_html__( 'Controls the height of the page title bar on mobile. Enter value including any valid CSS unit besides %% which does not work for page title bar, ex: 70px. %s', 'Avada' ), Avada()->settings->get_default_description( 'page_title_mobile_height' ) ),
				'type'        => 'text',
				'location'    => 'TAXO',
				'css_vars'    => [
					[
