		...
		FusionPageBuilder.fusion_faq = FusionPageBuilder.ElementView.extend( {
			...
			buildFaqList: function( atts ) {
				...
				_.each( queryData.faq_items, function( faq ) {
					...
					html += '<div class="fusion-toggle-icon-wrapper"><i class="fa-fusion-box active-icon awb-icon-plus" aria-hidden="true"></i><i class="fa-fusion-box inactive-icon awb-icon-minus" aria-hidden="true"></i></div>';
