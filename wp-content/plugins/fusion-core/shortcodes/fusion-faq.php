		...
		class FusionSC_Faq extends Fusion_Element {
			...
			public function render( $args, $content = '' ) {
				...
				while ( $faq_items->have_posts() ) :
					...
					$html .= '<div class="fusion-toggle-icon-wrapper"><div class="fusion-toggle-icon-wrapper-main"><div class="fusion-toggle-icon-wrapper-sub"><i class="fa-fusion-box active-icon awb-icon-plus" aria-hidden="true"></i><i class="fa-fusion-box inactive-icon awb-icon-minus" aria-hidden="true"></i></div></div></div>';
